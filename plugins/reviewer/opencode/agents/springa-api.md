---
description: INTERNAL — invoked only by the /parallel-review orchestrator. Do not invoke directly; invoke /parallel-review instead. Reviews API contract and schema compatibility for Springa.
mode: subagent
hidden: true
permission:
  read: allow
