...
- **Forbidden decisions:** Create a Shipwright ledger, design campaign, or adaptive multi-agent fan-out for a truly trivial narrow-surface change; take the reduction path before the gate; treat an unreadable platform reference as a reason to skip the gate or continue; reduce a small-diff / wide-surface change; treat reduction as a waiver of §11 or §12.
